...
class Gh3220ConnectionPathTest {
    ...
    fun `0x0b package frames are reported exactly once via rawdataFrames only`() = runTest {
        ...
        // 0x0B 多功能单帧：funcId=0x00，dataType=0x00，chMask=0x00000001，flag=0x04（多功能），
        // 帧 = [frameId=0][fifoId=1][rawdata 4B=0x01020304]
        val payload = bytes(0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x04, 0x06) + bytes(0x00, 0x01, 0x01, 0x02, 0x03, 0x04)
