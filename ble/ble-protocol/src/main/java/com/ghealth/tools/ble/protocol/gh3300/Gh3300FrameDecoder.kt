...
class Gh3300FrameDecoder {
    ...
    private fun decodeSingleFrame(buf: ByteArray, start: Int): Pair<Int, RawFrame> {
        ...
        Timber.v("GH3300 decodeSingleFrame: startPos=$start, packHeader bits=${raw.packHeader.bits}")
